...
def statMonth():
    ...
    if first_day.month == 12:
        last_day = current_date.replace(year=current_date.year + 1, month=1, day=1, hour=23, minute=59, second=59, microsecond=999999)
    else:
        last_day = current_date.replace(month=current_date.month + 1, day=1, hour=23, minute=59, second=59, microsecond=999999)
    ...
    results = (
        V2StatUser
            .select(
            V2StatUser,
            fn.SUM(V2StatUser.u + V2StatUser.d).alias('total_traffic')
        )
